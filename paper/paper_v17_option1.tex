...
{We report the complete direct and surrogate regularization paths} without choosing a penalty strength. Exploratory experiments across six counties are used separately to examine transferability, heterogeneity, and failure modes rather than to make confirmatory claims about those jurisdictions.}
