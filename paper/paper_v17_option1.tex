...
% Superseded title (replaced at B4.1): Covariance-Based Regularization for
% Regressivity in Machine-Learning Real Estate Valuation
\title{\latesttext{Targeting Price-Related Regressivity in Machine-Learning Mass Appraisal:
...
\latesttext{Machine-learning mass-appraisal models can be predictively strong yet leave a systematic
...
between log valuation errors and log sale price among observed sales, the classical
log-ratio/log-price slope. A Direct penalty acts on that squared covariance; a Jensen-derived
...
map and the Surrogate a generally multi-directional weighted projection. Seven chronological
rolling-origin folds, a later held-out block, and a separate 2025 forward period trace
prespecified penalty grids under a fixed base learner. A centered-spread post-hoc rescaling
...
and none dominates. Across those folds, the held-out block, and 2025 the correction-strength
