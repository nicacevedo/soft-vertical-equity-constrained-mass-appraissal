...
The final CCAO positive-$\rho$ candidate regions are approximately $0.36$--$2.56$ for Direct and $0.20$--$2.22$ for Surrogate; the machine-readable artifacts retain the exact grid values. The lower endpoints are soft activity markers. All endpoints are frozen from chronological CV before held-out and 2025 overlays are inspected; no out-of-time result changes an endpoint.
}
