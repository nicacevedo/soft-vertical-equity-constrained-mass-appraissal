...
definition. The full implementation used in the application should
...
correction, so the executed estimator is the usual biased, double-centered
$V$-statistic rather than an unbiased $U$-centered variant. The executed call passes the
