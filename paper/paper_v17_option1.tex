...
periods, and the diagnostics do not all turn on a common scale: the broader-dependence
and nonlinear-residual diagnostics reach their interior minima at different penalty
scales, and those locations shift across evaluation periods. The penalty grid was frozen
