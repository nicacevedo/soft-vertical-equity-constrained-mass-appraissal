...
used only to make tables and ratio-shape figures readable.
...
\multicolumn{10}{l}{\textbf{Direct penalty}} \\
\cmidrule(lr){1-10}
Direct & $\approx0.1$ & 0.894 & \$76,235 & \oldtext{\textit{source}}\latesttext{21.3\%} & \oldtext{\textit{source}}\latesttext{0.291} & 1.068 & -0.088 & 0.926 & -27.0\% \\
Direct & $\approx0.954$ & \textbf{0.899} & \textbf{\$74,485} & \oldtext{\textit{source}}\latesttext{\textbf{21.1\%}} & \oldtext{\textit{source}}\latesttext{0.290} & 1.060 & -0.075 & 0.940 & -21.9\% \\
Direct & $\approx10.481$ & \textbf{0.895} & \textbf{\$75,218} & \oldtext{\textit{source}}\latesttext{21.4\%} & \oldtext{\textit{source}}\latesttext{0.294} & \textbf{1.036} & -0.040\textsuperscript{*} & \textbf{0.984} & \textbf{-10.5\%} \\
Direct & 100 & 0.869 & \$84,918 & \oldtext{\textit{source}}\latesttext{23.9\%} & \oldtext{\textit{source}}\latesttext{0.325} & \textbf{1.029} & \textbf{-0.015} & \textbf{0.998} & \textbf{0.7\%} \\
\addlinespace[3pt]
\multicolumn{10}{l}{\textbf{Surrogate penalty}} \\
\cmidrule(lr){1-10}
Surrogate & $\approx0.1$ & 0.894 & \$75,897 & \oldtext{\textit{source}}\latesttext{\textbf{21.1\%}} & \oldtext{\textit{source}}\latesttext{0.292} & 1.064 & -0.079 & 0.931 & -22.7\% \\
Surrogate & $\approx0.954$ & \textbf{0.897} & \textbf{\$75,468} & \oldtext{\textit{source}}\latesttext{\textbf{21.0\%}} & \oldtext{\textit{source}}\latesttext{0.298} & 1.049 & -0.045\textsuperscript{*} & 0.953\textsuperscript{*} & -12.6\% \\
Surrogate & $\approx10.481$ & 0.893 & \$78,110 & \oldtext{\textit{source}}\latesttext{21.6\%} & \oldtext{\textit{source}}\latesttext{0.329} & \textbf{1.024} & \textbf{0.013} & \textbf{0.988} & \textbf{0.2\%} \\
Surrogate & 100 & 0.889 & \$82,094 & \oldtext{\textit{source}}\latesttext{22.8\%} & \oldtext{\textit{source}}\latesttext{0.357} & \textbf{1.010} & 0.042\textsuperscript{*} & \textbf{1.013} & \textbf{4.0\%} \\
\midrule
\addlinespace[2pt]
\multicolumn{10}{l}{\textit{Panel B: 2025 forward evaluation}} \\
\addlinespace[2pt]
...
\multicolumn{10}{l}{\textbf{Direct penalty}} \\
\cmidrule(lr){1-10}
Direct & $\approx0.1$ & \textbf{0.906} & \textbf{\$78,029} & \oldtext{\textit{source}}\latesttext{\textbf{20.7\%}} & \oldtext{\textit{source}}\latesttext{\textbf{0.278}} & 1.077 & -0.102 & 0.910 & -27.7\% \\
Direct & $\approx0.954$ & \textbf{0.910} & \textbf{\$77,139} & \oldtext{\textit{source}}\latesttext{\textbf{20.7\%}} & \oldtext{\textit{source}}\latesttext{0.279} & 1.069 & -0.090 & 0.926 & -23.9\% \\
Direct & $\approx10.481$ & 0.902 & \$79,187 & \oldtext{\textit{source}}\latesttext{20.9\%} & \oldtext{\textit{source}}\latesttext{0.281} & \textbf{1.042} & -0.049\textsuperscript{*} & \textbf{0.971} & \textbf{-11.9\%} \\
Direct & 100 & 0.873 & \$89,309 & \oldtext{\textit{source}}\latesttext{23.1\%} & \oldtext{\textit{source}}\latesttext{0.307} & \textbf{1.036} & -0.029\textsuperscript{*} & \textbf{0.983} & \textbf{-4.5\%} \\
\addlinespace[3pt]
\multicolumn{10}{l}{\textbf{Surrogate penalty}} \\
\cmidrule(lr){1-10}
Surrogate & $\approx0.1$ & \textbf{0.905} & \$78,546 & \oldtext{\textit{source}}\latesttext{\textbf{20.6\%}} & \oldtext{\textit{source}}\latesttext{0.279} & 1.074 & -0.095 & 0.914 & -24.7\% \\
Surrogate & $\approx0.954$ & \textbf{0.908} & \textbf{\$78,196} & \oldtext{\textit{source}}\latesttext{\textbf{20.4\%}} & \oldtext{\textit{source}}\latesttext{0.284} & 1.060 & -0.062 & 0.932 & \textbf{-15.3\%} \\
Surrogate & $\approx10.481$ & \textbf{0.905} & \$81,075 & \oldtext{\textit{source}}\latesttext{20.9\%} & \oldtext{\textit{source}}\latesttext{0.310} & \textbf{1.033} & \textbf{0.000} & \textbf{0.967} & \textbf{-2.0\%} \\
Surrogate & 100 & 0.900 & \$85,257 & \oldtext{\textit{source}}\latesttext{22.0\%} & \oldtext{\textit{source}}\latesttext{0.336} & \textbf{1.020} & 0.030\textsuperscript{*} & \textbf{0.987} & \textbf{1.7\%} \\
\bottomrule
\end{tabular}}
\vspace{1mm}
\begin{minipage}{\textwidth}
...
\latesttext{This appendix contains the complete diagnostics underlying the compact main-text regularization-path presentation. It is organized around the final augmented paths and not around a selected configuration; only the compact display anchors remain prespecified presentation choices.}
...
\scriptsize
\renewcommand{\arraystretch}{1.08}
\caption{Complementary regularization-path summary at the same prespecified display anchors: valuation level, horizontal uniformity, and mechanism/residual structure.}
...
\multicolumn{10}{l}{\textbf{Direct penalty}} \\
\cmidrule(lr){1-10}
Direct & $\approx0.1$ & \oldtext{\textit{source}}\latesttext{0.924} & \oldtext{\textit{source}}\latesttext{0.983} & \oldtext{\textit{source}}\latesttext{0.920} & \oldtext{\textit{source}}\latesttext{21.6\%} & \oldtext{\textit{source}}\latesttext{39.8\%} & -0.147 & 0.119 & 0.382 \\
Direct & $\approx0.954$ & \oldtext{\textit{source}}\latesttext{0.936} & \oldtext{\textit{source}}\latesttext{\textbf{0.993}} & \oldtext{\textit{source}}\latesttext{0.936} & \oldtext{\textit{source}}\latesttext{21.6\%} & \oldtext{\textit{source}}\latesttext{39.9\%} & -0.134 & 0.122 & 0.359 \\
Direct & $\approx10.481$ & \oldtext{\textit{source}}\latesttext{0.953} & \oldtext{\textit{source}}\latesttext{\textbf{1.005}} & \oldtext{\textit{source}}\latesttext{0.970} & \oldtext{\textit{source}}\latesttext{21.9\%} & \oldtext{\textit{source}}\latesttext{\textbf{39.4\%}} & -0.096 & 0.132 & 0.302 \\
Direct & 100 & \oldtext{\textit{source}}\latesttext{0.968} & \oldtext{\textit{source}}\latesttext{1.022} & \oldtext{\textit{source}}\latesttext{\textbf{0.993}} & \oldtext{\textit{source}}\latesttext{24.5\%} & \oldtext{\textit{source}}\latesttext{41.5\%} & \textbf{-0.079} & \textbf{0.115} & 0.265 \\
\addlinespace[3pt]
\multicolumn{10}{l}{\textbf{Surrogate penalty}} \\
\cmidrule(lr){1-10}
Surrogate & $\approx0.1$ & \oldtext{\textit{source}}\latesttext{0.927} & \oldtext{\textit{source}}\latesttext{0.982} & \oldtext{\textit{source}}\latesttext{0.923} & \oldtext{\textit{source}}\latesttext{\textbf{21.5\%}} & \oldtext{\textit{source}}\latesttext{39.9\%} & -0.138 & \textbf{0.113} & 0.367 \\
Surrogate & $\approx0.954$ & \oldtext{\textit{source}}\latesttext{0.929} & \oldtext{\textit{source}}\latesttext{0.975} & \oldtext{\textit{source}}\latesttext{0.930} & \oldtext{\textit{source}}\latesttext{\textbf{21.4\%}} & \oldtext{\textit{source}}\latesttext{\textbf{38.2\%}} & -0.102 & \textbf{0.099} & 0.310 \\
Surrogate & $\approx10.481$ & \oldtext{\textit{source}}\latesttext{0.927} & \oldtext{\textit{source}}\latesttext{0.953} & \oldtext{\textit{source}}\latesttext{0.931} & \oldtext{\textit{source}}\latesttext{22.2\%} & \oldtext{\textit{source}}\latesttext{\textbf{38.5\%}} & \textbf{-0.036} & \textbf{0.103} & 0.250 \\
Surrogate & 100 & \oldtext{\textit{source}}\latesttext{0.923} & \oldtext{\textit{source}}\latesttext{0.937} & \oldtext{\textit{source}}\latesttext{0.928} & \oldtext{\textit{source}}\latesttext{23.5\%} & \oldtext{\textit{source}}\latesttext{40.3\%} & \textbf{-0.001} & 0.124 & 0.267 \\
\midrule
\addlinespace[2pt]
\multicolumn{10}{l}{\textit{Panel B: 2025 forward evaluation}} \\
\addlinespace[2pt]
...
\multicolumn{10}{l}{\textbf{Direct penalty}} \\
\cmidrule(lr){1-10}
Direct & $\approx0.1$ & \oldtext{\textit{source}}\latesttext{0.952} & \oldtext{\textit{source}}\latesttext{\textbf{1.015}} & \oldtext{\textit{source}}\latesttext{0.942} & \oldtext{\textit{source}}\latesttext{\textbf{21.2\%}} & \oldtext{\textit{source}}\latesttext{\textbf{37.2\%}} & -0.160 & 0.121 & 0.416 \\
Direct & $\approx0.954$ & \oldtext{\textit{source}}\latesttext{0.957} & \oldtext{\textit{source}}\latesttext{1.019} & \oldtext{\textit{source}}\latesttext{0.954} & \oldtext{\textit{source}}\latesttext{\textbf{21.2\%}} & \oldtext{\textit{source}}\latesttext{37.2\%} & -0.148 & 0.127 & 0.392 \\
Direct & $\approx10.481$ & \oldtext{\textit{source}}\latesttext{0.978} & \oldtext{\textit{source}}\latesttext{1.032} & \oldtext{\textit{source}}\latesttext{\textbf{0.991}} & \oldtext{\textit{source}}\latesttext{21.3\%} & \oldtext{\textit{source}}\latesttext{37.4\%} & \textbf{-0.105} & 0.134 & 0.318 \\
Direct & 100 & \oldtext{\textit{source}}\latesttext{\textbf{0.992}} & \oldtext{\textit{source}}\latesttext{1.049} & \oldtext{\textit{source}}\latesttext{\textbf{1.012}} & \oldtext{\textit{source}}\latesttext{23.3\%} & \oldtext{\textit{source}}\latesttext{40.3\%} & \textbf{-0.093} & \textbf{0.119} & 0.281 \\
\addlinespace[3pt]
\multicolumn{10}{l}{\textbf{Surrogate penalty}} \\
\cmidrule(lr){1-10}
Surrogate & $\approx0.1$ & \oldtext{\textit{source}}\latesttext{0.948} & \oldtext{\textit{source}}\latesttext{\textbf{1.009}} & \oldtext{\textit{source}}\latesttext{0.939} & \oldtext{\textit{source}}\latesttext{\textbf{21.1\%}} & \oldtext{\textit{source}}\latesttext{\textbf{36.8\%}} & -0.153 & \textbf{0.116} & 0.402 \\
Surrogate & $\approx0.954$ & \oldtext{\textit{source}}\latesttext{0.950} & \oldtext{\textit{source}}\latesttext{\textbf{1.003}} & \oldtext{\textit{source}}\latesttext{0.946} & \oldtext{\textit{source}}\latesttext{\textbf{20.9\%}} & \oldtext{\textit{source}}\latesttext{\textbf{36.1\%}} & -0.120 & \textbf{0.096} & 0.343 \\
Surrogate & $\approx10.481$ & \oldtext{\textit{source}}\latesttext{0.949} & \oldtext{\textit{source}}\latesttext{0.979} & \oldtext{\textit{source}}\latesttext{0.948} & \oldtext{\textit{source}}\latesttext{21.5\%} & \oldtext{\textit{source}}\latesttext{\textbf{35.9\%}} & \textbf{-0.050} & \textbf{0.092} & \textbf{0.258} \\
Surrogate & 100 & \oldtext{\textit{source}}\latesttext{0.948} & \oldtext{\textit{source}}\latesttext{0.964} & \oldtext{\textit{source}}\latesttext{0.945} & \oldtext{\textit{source}}\latesttext{22.7\%} & \oldtext{\textit{source}}\latesttext{\textbf{36.8\%}} & \textbf{-0.015} & \textbf{0.111} & \textbf{0.266} \\
\bottomrule
\end{tabular}}
\vspace{1mm}
\begin{minipage}{\textwidth}
\scriptsize
\emph{Notes.}
The three valuation-level ratios are compared by distance from one; COD and COV summarize horizontal dispersion. For the mechanism/residual-structure diagnostics, smaller $|\beta_{\log}|$, $\Delta_{\mathrm{NL}}$, and dCor indicate less first-order, non-affine conditional-mean, and broader residual--price structure, respectively; these directions are diagnostic rather than assessor-standard equity targets. Boldface denotes equality with or improvement upon both baselines under the relevant direction and does not denote statistical significance, formal compliance, or model selection.
\end{minipage}
\end{table}
}
...
\caption{\oldtext{Predictive-metric paths and valuation-level/uniformity paths along the Direct and Surrogate grids, with held-out and 2025 evaluations overlaid. Gray shading, where present, is the CV-derived descriptive transition span.}\latesttext{Predictive-metric paths and valuation-level/uniformity paths along the Direct and Surrogate grids, with held-out and 2025 evaluations overlaid. Gray fill and dashed vertical boundaries mark the frozen family-specific CV-derived descriptive transition span. Valuation-level panels include the ratio $=1$ reference.}}
...
\caption{\oldtext{Vertical-equity metric paths versus $\rho$ for Direct and Surrogate. Gray shading, where present, is the CV-derived descriptive transition span.}\latesttext{Vertical-equity metric paths versus $\rho$ for Direct and Surrogate. Gray fill and dashed vertical boundaries mark the frozen family-specific CV-derived descriptive transition span. Reference lines mark PRD $=1$, PRB $=0$, MKI $=1$, and VEI $=0$.}}
...
\caption{\oldtext{Chronological-fold predictive-metric paths (thin gray) and equal-weight CV means (thick). Gray shading, where present, is the CV-derived descriptive transition span.}\latesttext{Chronological-fold predictive-metric paths (thin gray) and equal-weight CV means (thick). Gray fill and dashed vertical boundaries mark the frozen family-specific CV-derived descriptive transition span.}}
...
\caption{\oldtext{Chronological-fold valuation-level and uniformity paths (thin gray) and equal-weight CV means (thick).}\latesttext{Chronological-fold valuation-level and uniformity paths (thin gray) and equal-weight CV means (thick). Gray fill and dashed vertical boundaries mark the frozen family-specific CV-derived descriptive transition span. Valuation-level panels include the ratio $=1$ reference.}}
...
\caption{\oldtext{Chronological-fold vertical-equity paths (thin gray) and equal-weight CV means (thick).}\latesttext{Chronological-fold vertical-equity paths (thin gray) and equal-weight CV means (thick). Gray fill and dashed vertical boundaries mark the frozen family-specific CV-derived descriptive transition span. Reference lines mark PRD $=1$, PRB $=0$, MKI $=1$, and VEI $=0$.}}
