...
\latesttext{The decade-spaced rows in Table~\ref{tab:path_anchor_summary} are therefore descriptive snapshots of different penalty scales, not evidence of a stable multi-metric optimum. Section~\ref{subsec:path_stability_results} evaluates path stability separately using the frozen transition rule.}
