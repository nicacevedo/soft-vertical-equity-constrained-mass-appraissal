...
Production training & 2016-01-01--2024-12-31 & 382,897 \\
...
Production training & 382,897 eligible 2016--2024 sales \\
...
2025 forward & Direct, $\rho=0$ & 0.904 & 0.279 & -0.161 & 3.24e-02 & 3.09e-01 \\
2025 forward & Surrogate, $\rho=0$ & 0.904 & 0.279 & -0.161 & 3.24e-02 & 3.09e-01 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[!htbp]
\centering
\safeincludegraphics[width=0.92\textwidth]{img/generated_v6_preselection/ratio_shape_evolution.pdf}
...
\begin{figure}[!htbp]
\centering
\safeincludegraphics[width=0.86\textwidth]{img/generated_v6_preselection/mechanism_vs_rho.pdf}
...
Along the Direct path, held-out $R^2_P$ moves from 0.893 at $\rho=0$ to 0.869 at $\rho=100$, while $\beta_{\log}$ moves from -0.147 to -0.079 and VEI from -26.2\% to 0.7\%. Along the Surrogate path, held-out $R^2_P$ moves from 0.893 to 0.889, $\beta_{\log}$ from -0.147 to -0.001, and VEI from -26.2\% to 4.0\%. The 2025 forward paths move in the same direction. On Direct, the first-order slope becomes less negative from $\rho=0$ to $\rho=100$ in 7 of 7 folds. These statements describe the ordered paths; they do not identify an operating point.
...
\caption{Companion accuracy--equity trajectories for PRB and MKI against $R^2_P$ on the held-out and 2025 samples.}
...
\begin{figure}[!htbp]
\centering
\safeincludegraphics[width=0.92\textwidth]{img/generated_v6_preselection/predictive_metric_paths.pdf}\\[2mm]
\safeincludegraphics[width=0.92\textwidth]{img/generated_v6_preselection/level_uniformity_paths.pdf}
...
\begin{figure}[!htbp]
\centering
\safeincludegraphics[width=0.86\textwidth]{img/generated_v6_preselection/cv_fold_stability.pdf}
...
\begin{figure}[!htbp]
\centering
\safeincludegraphics[width=0.92\textwidth]{img/generated_v6_preselection/vei_percentile_group_profile.pdf}
