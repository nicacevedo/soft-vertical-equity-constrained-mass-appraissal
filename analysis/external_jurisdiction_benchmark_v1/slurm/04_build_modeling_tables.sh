...
#SBATCH --mem=80G
#SBATCH --time=4:00:00
#SBATCH --output=analysis/external_jurisdiction_benchmark_v1/logs/tables_%A_%a.out
#SBATCH --error=analysis/external_jurisdiction_benchmark_v1/logs/tables_%A_%a.err
set -euo pipefail
...
echo "tables county=${KEY} cpus=${CPUS} host=$(hostname) partition=${SLURM_JOB_PARTITION:-} start=$(date -Is)"
